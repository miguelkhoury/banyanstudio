...
?>
		...
		<ul class=" filter nav nav-pills">
					...
					<li class="active"><a href="javascript:void(0)" class="web"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span> Web</a></li>
                    ...
                    <li class="active"><a href="javascript:void(0)" class="print"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Print</a></li>
